...
- `sdk/agent/compaction/service_test.go` - summary prefix/tagging, overflow-limit checks (`context_window - reserve_output_tokens`), recent-user retention, strict last-match summary extraction (`<summary>`/`<compaction_summary>`), timeout-bounded compaction, rune-aware tool-context threshold gating, model-aware summary prompts, protected-tool snapshot prioritization, and tool-call/tool-result pair repair after destroyed tool outputs are filtered (`sdk/agent/compaction/service_test.go:54`, `sdk/agent/compaction/service_test.go:147`, `sdk/agent/compaction/service_test.go:300`, `sdk/agent/compaction/service_test.go:372`)
